...
export class Backend implements backendInterface {
    ...
    async createVisitEntry(arg0: string, arg1: bigint, arg2: string, arg3: string, arg4: bigint, arg5: bigint, arg6: string, arg7: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createVisitEntry(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteVisitEntry(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteVisitEntry(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async editVisitEntry(arg0: bigint, arg1: string, arg2: bigint, arg3: string, arg4: string, arg5: bigint, arg6: bigint, arg7: string, arg8: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.editVisitEntry(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserVisitEntries(): Promise<Array<VisitEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserVisitEntries();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getVisitEntry(arg0: bigint): Promise<VisitEntry> {
        if (this.processError) {
            try {
                const result = await this.actor.getVisitEntry(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
